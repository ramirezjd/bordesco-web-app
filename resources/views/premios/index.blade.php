...
<div class="container">
    <div class="row px-auto justify-content-between mb-3">
        ...
        <div class="col-auto text-right">
            <a href="{{ route('premios.create') }}" class="btn btn-success rounded-circle">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">{{ $premio->id}}</td>
                           ...
                           <td class="text-center">
                              <ul class="table-controls">
                                ...
                                <li>
                                    <a href="{{ route('premios.edit',$premio->id) }}" data-toggle="tooltip" data-placement="top" title="Editar">
