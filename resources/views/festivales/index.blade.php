...
<div class="container">
    <div class="row px-auto justify-content-between mb-3">
        <div class="col-auto margin-tb">
            <h2>Gestionar Festivales</h2>
        </div>
        <div class="col-auto text-right">
            <a href="{{ route('festivales.create') }}" class="btn btn-success rounded-circle">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">{{ $festival->id}}</td>
                            
                            <td class="text-center">{{ $festival->nombre}} </td>

                            <td class="text-center">{{ $festival->fecha_creacion}}</td>

                           <td class="text-center">
                              <ul class="table-controls">

                                <li>
                                    <a href="{{ route('festivales.edit',$festival->id) }}" data-toggle="tooltip" data-placement="top" title="Editar">
                                ...
                                <li>
                                    <form action="{{ route('festivales.destroy',$festival->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
