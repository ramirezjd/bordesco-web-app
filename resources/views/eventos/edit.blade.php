    ...
    <form action="{{ route('eventos.update', $evento->id) }}" method="POST">
        ...
        <div class="row mx-auto">
            <div class="col-md-4">
                ...
                <input class="form-control " type="text" name="anio" placeholder="Año" maxlength="4" value="{{$evento->ano}}" required>
            </div>
            <div class="col-md-4">
                <label for="inicio_convocatoria">Inicio de convocatoria</label>
                <input class="form-control " type="date" name="inicio_convocatoria" placeholder="Nombre de la categoria" value="{{$evento->inicio_convocatoria}}" required>
            </div>
            <div class="col-md-4">
                <label for="fin_convocatoria">Fin de convocatoria</label>
                <input class="form-control " type="date" name="fin_convocatoria" placeholder="Nombre de la categoria" value="{{$evento->fin_convocatoria}}" required>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    festivalSelect.value={{ $evento->festival->id }};
</script>
@endsection