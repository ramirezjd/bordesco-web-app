...
<div class="container">
    <div class="row px-auto justify-content-between mb-3">
        ...
        <div class="col-auto text-right">
            <a href="{{ route('eventos.create') }}" class="btn btn-success rounded-circle">
                ...
                <table class="table table-bordered table-hover table-striped table-checkable table-highlight-head mb-1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $evento->ano}}</td>
                            <td class="text-center">{{ $evento->inicio_convocatoria}}</td>
                            <td class="text-center">{{ $evento->fin_convocatoria}}</td>
                            <td class="text-center">{{ $evento->festival->id}} - {{ $evento->festival->nombre}}</td>
                            <td class="text-center">
                              <ul class="table-controls">
																<li>
                                    <a href="{{ route('agregarCategoria',$evento->id) }}" data-toggle="tooltip" data-placement="top" title="Agregar categorias">
																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                                    </a>
                                </li>
																<li>
                                    <a href="{{ route('agregarCurador',$evento->id) }}" data-toggle="tooltip" data-placement="top" title="Agregar curadores" style="color: #3e22ff;">
																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                                    </a>
                                </li>

                                <li>
                                    <a href="{{ route('eventos.edit',$evento->id) }}" data-toggle="tooltip" data-placement="top" title="Editar">
