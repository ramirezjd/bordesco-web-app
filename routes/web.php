...
Route::resource('/festivales', 'FestivalController');
Route::resource('/eventos', 'EventoController');
Route::get('/votaciones/{id}', 'VotacionController@index')->name('votaciones');
Route::get('/votaciones/votar/{id}', 'VotacionController@show')->name('votar');
Route::post('/votaciones/saveVotos/{id}', 'VotacionController@update')->name('guardarVotos');
